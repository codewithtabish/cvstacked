...
interface TemplateEighteenProps {
  resume: ResumeData;
  id?: string;
}
...
export function TemplateEighteen({ resume, id = "resume-page" }: TemplateEighteenProps) {
      ...
      >
        ...
        {resume.summary?.trim() && (
          <section>
            ...
            <p style={{ ...bodyTextStyle, textAlign: "justify" }}>{resume.summary}</p>
          </section>
        )}
