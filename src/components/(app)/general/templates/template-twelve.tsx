...
export function TemplateTwelve({ resume, id = "resume-page" }: TemplateTwelveProps) {
  ...
  return (
    <article
      ...
      data-template-id="minimal"
      data-theme={resume.themeId}
      data-font={resume.fontFamilyId}
      data-typography-scale={resume.typographyScale}
    >
      {/* ============================================================
          HEADER — Creative Grid
          ============================================================ */}
      <header
        style={{
          display: "grid",
          gridTemplateColumns: resume.personal.photo ? "1fr 64px" : "1fr",
          gap: "18px",
          alignItems: "center",
          marginBottom: "16px",
          paddingBottom: "14px",
