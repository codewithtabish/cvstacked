...
export function TemplateTen({ resume, id = "resume-page" }: TemplateTenProps) {
  ...
  const hasPhoto = Boolean(resume.personal.photo);
  const hasContact =
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Name + Title (sidebar version for impact) */}
        <div>
          <h1
            style={{
              margin: 0,
        ...
        {hasContact && (
          <div>
            <SectionHeading accent={colors.accent}>Contact</SectionHeading>
            <div
              style={{
                display: "flex",
                flexDirection: "column",
